...
import { defaultTotalGetter, defaultRowsGetter, defaultHttpCodeGetter } from "./pagination/deserialization"
...
onMounted(async () => {
  ...
  rows.value = rowUtils.sortRowData(
    processedRowObjects, props.headings
  )
